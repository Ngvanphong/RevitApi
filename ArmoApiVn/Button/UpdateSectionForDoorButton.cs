 ...
 public  class UpdateSectionForDoorButton
    {
        public void UpdateDoorSection(UIControlledApplication application)
        {
            ...
            Image img = ArmoApiVn.Properties.Resources.iconfinder_back_undo_62658;
            ImageSource imgSrc = EntensionMethod.GetImageSource(img);
            PushButtonData btnData = new PushButtonData("UpdateDoor", "UpdateDoor", Assembly.GetExecutingAssembly().Location, "ArmoApiVn.UpdateDoorBinding")
            {
