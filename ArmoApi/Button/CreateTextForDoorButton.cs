  ...
  public  class CreateTextForDoorButton
    {
        public void CreateText(UIControlledApplication application)
        {
            ...
            Image img = ArmoApi.Properties.Resources.iconfinder_48_62705;
            ImageSource imgSrc = EntensionMethod.GetImageSource(img);
            PushButtonData btnData = new PushButtonData("DoorTag", "TagDoor", Assembly.GetExecutingAssembly().Location, "ArmoApi.CreateTextForDoorBinding")
            {
