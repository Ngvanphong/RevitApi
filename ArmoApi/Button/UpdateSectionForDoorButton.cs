 ...
 public  class UpdateSectionForDoorButton
    {
        public void UpdateDoorSection(UIControlledApplication application)
        {
            ...
            Image img = ArmoApi.Properties.Resources.iconfinder_back_undo_62658;
            ImageSource imgSrc = EntensionMethod.GetImageSource(img);
            PushButtonData btnData = new PushButtonData("UpdateDoor", "UpdateDoor", Assembly.GetExecutingAssembly().Location, "ArmoApi.UpdateDoorBinding")
            {
